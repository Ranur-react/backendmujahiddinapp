...
if (isset($_POST['kode_user'])) {
    ...
    $query = mysqli_query($conn, " UPDATE tb_user SET  nama_user= '$namauser', username_user= '$usernameuser', password_user= '$passworduser',   level_user= '$leveluser' WHERE kode_user= '$kodeuser';");
